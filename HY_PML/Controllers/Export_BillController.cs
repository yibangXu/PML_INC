...
VALUES(@DC, @SUBNO, @SUBST, @IDNO, @MONEYS, @dPTNO, @TransferBy, @TransferTime, @CcNo, @DestNo, @PType, @PiecesNo, @Weight, @Freight, @CustomsPay, @Tariff, @OtherPayTax, @OtherPayNoTax, @ToPayment, @ToPaymentCurrency, @AgentPay, @AgentPayCurrency,@LadingDate,@AStatNo,@SendCHName,@CName,@ProdIdPay,@InsurancePay,@StatNo,@SectorNo,@SectorName,@HubName,@SendCustAddr,@SendECustAddr,@AStatName,@StatName,@HubNo); 
IF @@Error <> 0 BEGIN SET @chk = 1 END ");
